...
| Saurashtra | 81 | No | `A880` | `A8DF` |
| Devanagari Extended | 28 | No | `A8E0` | `A8FF` |
| Kayah Li | 47 | No | `A900` | `A92F` |
| Rejang | 36 | No | `A930` | `A95F` |
| Hangul Jamo Extended-A | 29 | No | `A960` | `A97F` |
| Javanese | **90** | **Yes** | `A980` | `A9DF` |
| Myanmar Extended-B | 0 | No | `A9E0` | `A9FF` |
| Cham | 82 | No | `AA00` | `AA5F` |
| Myanmar Extended-A | 28 | No | `AA60` | `AA7F` |
| Tai Viet | 71 | No | `AA80` | `AADF` |
| Meetei Mayek Extensions | 0 | No | `AAE0` | `AAFF` |
| Ethiopic Extended-A | 0 | No | `AB00` | `AB2F` |
| Latin Extended-E | 0 | No | `AB30` | `AB6F` |
...
| CJK Compatibility Ideographs | 470 | No | `F900` | `FAFF` |
...
| Combining Half Marks | 7 | No | `FE20` | `FE2F` |
...
| Ancient Greek Numbers | 75 | No | `10140` | `1018F` |
| Ancient Symbols | 12 | No | `10190` | `101CF` |
| Phaistos Disc | 46 | No | `101D0` | `101FF` |
| Lycian | 29 | No | `10280` | `1029F` |
| Carian | 49 | No | `102A0` | `102DF` |
| Coptic Epact Numbers | 0 | No | `102E0` | `102FF` |
| Old Italic | 35 | No | `10300` | `1032F` |
| Gothic | 27 | No | `10330` | `1034F` |
| Old Permic | 0 | No | `10350` | `1037F` |
...
| Elbasan | 0 | No | `10500` | `1052F` |
| Caucasian Albanian | 0 | No | `10530` | `1056F` |
| Linear A | 0 | No | `10600` | `1077F` |
| Cypriot Syllabary | 54 | No | `10800` | `1083F` |
| Imperial Aramaic | 30 | No | `10840` | `1085F` |
| Palmyrene | 0 | No | `10860` | `1087F` |
| Nabataean | 0 | No | `10880` | `108AF` |
| Hatran | 0 | No | `108E0` | `108FF` |
| Phoenician | 28 | No | `10900` | `1091F` |
| Lydian | 26 | No | `10920` | `1093F` |
| Meroitic Hieroglyphs | 0 | No | `10980` | `1099F` |
| Meroitic Cursive | 0 | No | `109A0` | `109FF` |
| Kharoshthi | 65 | No | `10A00` | `10A5F` |
| Old South Arabian | 31 | No | `10A60` | `10A7F` |
| Old North Arabian | 0 | No | `10A80` | `10A9F` |
| Manichaean | 0 | No | `10AC0` | `10AFF` |
| Avestan | 60 | No | `10B00` | `10B3F` |
| Inscriptional Parthian | 29 | No | `10B40` | `10B5F` |
| Inscriptional Pahlavi | 26 | No | `10B60` | `10B7F` |
| Psalter Pahlavi | 0 | No | `10B80` | `10BAF` |
| Old Turkic | 73 | No | `10C00` | `10C4F` |
| Old Hungarian | 0 | No | `10C80` | `10CFF` |
| Rumi Numeral Symbols | 31 | No | `10E60` | `10E7F` |
| Brahmi | 0 | No | `11000` | `1107F` |
| Kaithi | 66 | No | `11080` | `110CF` |
| Sora Sompeng | 0 | No | `110D0` | `110FF` |
| Chakma | 0 | No | `11100` | `1114F` |
| Mahajani | 0 | No | `11150` | `1117F` |
| Sharada | 0 | No | `11180` | `111DF` |
| Sinhala Archaic Numbers | 0 | No | `111E0` | `111FF` |
| Khojki | 0 | No | `11200` | `1124F` |
| Multani | 0 | No | `11280` | `112AF` |
| Khudawadi | 0 | No | `112B0` | `112FF` |
| Grantha | 0 | No | `11300` | `1137F` |
| Tirhuta | 0 | No | `11480` | `114DF` |
| Siddham | 0 | No | `11580` | `115FF` |
| Modi | 0 | No | `11600` | `1165F` |
| Takri | 0 | No | `11680` | `116CF` |
| Ahom | 0 | No | `11700` | `1173F` |
| Warang Citi | 0 | No | `118A0` | `118FF` |
| Pau Cin Hau | 0 | No | `11AC0` | `11AFF` |
| Cuneiform | 879 | No | `12000` | `123FF` |
| Cuneiform Numbers and Punctuation | 103 | No | `12400` | `1247F` |
| Early Dynastic Cuneiform | 0 | No | `12480` | `1254F` |
| Egyptian Hieroglyphs | 1071 | No | `13000` | `1342F` |
| Anatolian Hieroglyphs | 0 | No | `14400` | `1467F` |
| Bamum Supplement | 0 | No | `16800` | `16A3F` |
| Mro | 0 | No | `16A40` | `16A6F` |
| Bassa Vah | 0 | No | `16AD0` | `16AFF` |
| Pahawh Hmong | 0 | No | `16B00` | `16B8F` |
| Miao | 0 | No | `16F00` | `16F9F` |
| Kana Supplement | 0 | No | `1B000` | `1B0FF` |
| Duployan | 0 | No | `1BC00` | `1BC9F` |
| Shorthand Format Controls | 0 | No | `1BCA0` | `1BCAF` |
| Byzantine Musical Symbols | 246 | No | `1D000` | `1D0FF` |
| Musical Symbols | 220 | No | `1D100` | `1D1FF` |
| Ancient Greek Musical Notation | 70 | No | `1D200` | `1D24F` |
| Tai Xuan Jing Symbols | 87 | No | `1D300` | `1D35F` |
| Counting Rod Numerals | 18 | No | `1D360` | `1D37F` |
| Mathematical Alphanumeric Symbols | 995 | No | `1D400` | `1D7FF` |
| Sutton SignWriting | 0 | No | `1D800` | `1DAAF` |
| Mende Kikakui | 0 | No | `1E800` | `1E8DF` |
| Arabic Mathematical Alphabetic Symbols | 0 | No | `1EE00` | `1EEFF` |
| Mahjong Tiles | 44 | No | `1F000` | `1F02F` |
| Domino Tiles | **100** | **Yes** | `1F030` | `1F09F` |
| Playing Cards | 0 | No | `1F0A0` | `1F0FF` |
| Enclosed Alphanumeric Supplement | **63** | **Yes** | `1F100` | `1F1FF` |
| Enclosed Ideographic Supplement | 44 | No | `1F200` | `1F2FF` |
| Miscellaneous Symbols and Pictographs | 0 | No | `1F300` | `1F5FF` |
| Emoticons | 0 | No | `1F600` | `1F64F` |
| Ornamental Dingbats | 0 | No | `1F650` | `1F67F` |
| Transport and Map Symbols | 0 | No | `1F680` | `1F6FF` |
| Alchemical Symbols | 0 | No | `1F700` | `1F77F` |
| Geometric Shapes Extended | 0 | No | `1F780` | `1F7FF` |
| Supplemental Arrows-C | 0 | No | `1F800` | `1F8FF` |
| Supplemental Symbols and Pictographs | 0 | No | `1F900` | `1F9FF` |
| CJK Unified Ideographs Extension B | 42711 | No | `20000` | `2A6DF` |
| CJK Unified Ideographs Extension C | 4149 | No | `2A700` | `2B73F` |
| CJK Unified Ideographs Extension D | 0 | No | `2B740` | `2B81F` |
| CJK Unified Ideographs Extension E | 0 | No | `2B820` | `2CEAF` |
